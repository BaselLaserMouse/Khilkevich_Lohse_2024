...
Run messages are appended to TPrime.log in the app folder.
...
- Each from-stream needs a zero-based stream_index that you assign arbitrarily; it merely links event files with their source streams.
