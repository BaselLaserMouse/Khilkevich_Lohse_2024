function Run_CatGT_just_probes(ses_path_raw, ses_name)

    dir_cont = dir(ses_path_raw);
    dir_cont(1:2) = [];
    ...
    if probe_count<1
        ...
        catGT_matlab_path = 'C:\Users\NPX1\Documents\code\DMDM_NPX_postprocessing_tools\CatGT-Matlab';
        cd(catGT_matlab_path);
