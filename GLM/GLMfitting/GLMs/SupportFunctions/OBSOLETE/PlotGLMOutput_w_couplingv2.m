...
%%
load('GLM_PostSpikeandStimOnlyAK_1108135_S06_Clu15.mat')
figure;
plot(GLM.Smooth.Ih,'b');
hold on;plot(GLM.Smooth.Itot,'b');
hold on;plot((GLM.Smooth.Istm*4)-4,'r');
hold on;plot(GLM.Smooth.Ih,'g');
