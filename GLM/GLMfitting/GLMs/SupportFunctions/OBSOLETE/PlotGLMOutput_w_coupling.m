...
for curClu=1:length(Expt(e).GLMparams.CluSelect) % which cluster to plot
    ...
    plot(Expt(e).Clu(CluSelect(curClu)).GLM.ML.iht,exp(Expt(e).Clu(CluSelect(curClu)).GLM.ML.ihbas2*Expt(e).Clu(CluSelect(curClu)).GLM.ML.ihw2)); axis tight;
    box off
    ylabel('gain')
    xlim([0 .050])
    legend off
    ...
    plot(Expt(e).Clu(CluSelect(curClu)).GLM.L2.iht,exp(Expt(e).Clu(CluSelect(curClu)).GLM.L2.ihbas2*Expt(e).Clu(CluSelect(curClu)).GLM.L2.ihw2)); axis tight;
    box off
    ylabel('gain')
    xlim([0 .050])
    legend off
    ...
    plot(Expt(e).Clu(CluSelect(curClu)).GLM.Smooth.iht,exp(Expt(e).Clu(CluSelect(curClu)).GLM.Smooth.ihbas2*Expt(e).Clu(CluSelect(curClu)).GLM.Smooth.ihw2)); axis tight;
    box off
    ylabel('gain')
    xlim([0 .050])
    legend off
