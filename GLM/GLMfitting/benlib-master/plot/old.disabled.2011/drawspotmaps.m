...
% this draws the 50% contours of a load of spotmaps on top of one another.
% it's probably superceded by drawrawspotmaps.m

% used for scotoma mapping in Reese well #17
