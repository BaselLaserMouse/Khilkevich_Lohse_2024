...
% adjusted jam's p2mSpotmap trivially so it outputs 
% the 50% contour as rfinfo.x and rfinfo.y, and the whole spotmap as
% rfinfo.rawx, rfinfo.rawy (gridmarks) and rfinfo.rawz
% also it now returns the size of spots used as rfinfo.spot_width and 
% rfinfo.spot_length
...
% BW
rfinfo.spot_length = pf.rec(1).params.spot_length;
rfinfo.spot_width  = pf.rec(1).params.spot_width;

rfinfo.spot_length_deg = rfinfo.spot_length/ppd;
rfinfo.spot_width_deg = rfinfo.spot_width/ppd;
