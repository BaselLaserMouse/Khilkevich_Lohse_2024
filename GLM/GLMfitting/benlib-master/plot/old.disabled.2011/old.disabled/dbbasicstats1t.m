function stats = dbbasicstats1t(in)

% for single trial natrev
clf;
...
if size(rc,2) > 7
  % multiple-trial data. do all analyses
  ...
  b = nan;
  raster_xc = nan;
  raster_xc_with_mean = nan;
  raster_xc_halves = nan;
end

stats.spikecount = nansum(spikes_mn)
stats.meanrate   = stats.spikecount./size(psth,2)*hz
stats.sparseness = sp;
stats.kurtosis   = k;
stats.fano       = b;
