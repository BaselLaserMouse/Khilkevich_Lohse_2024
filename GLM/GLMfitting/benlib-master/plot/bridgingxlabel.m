function [axisHandle,textHandle] = bridgingxlabel(varargin)
% add a label centred under all subplots
...
textHandle = text(.5,-.07*dist,txt,'verticalalignment','middle','horizontalalignment','center');
