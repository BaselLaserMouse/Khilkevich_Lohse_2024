...
function psthViewer(spikeTimes, clu, eventTimes, window, trGroups, group_ind, groups_numb)
...
if isempty(myData.plotAxes)
    for p = 1:2
        if p==1
            subplot_ind = myData.group_ind;
        else
            subplot_ind = myData.group_ind+myData.groups_numb;
        end
